...
class GeometryGenerationServerRequest:
    ...
    backend: str = "sam3d"
    """3D generation backend to use. Either "sam3d" or "hunyuan3d"."""
...
class GeometryGenerationServerResponse:
    ...
    """Runtime artifact identifier for HTTP download, if exposed by the server."""

    download_url: str | None = None
    """Relative URL for downloading the generated GLB, if exposed by the server."""

    collision: dict | None = None
    """Mandatory collision artifact metadata generated by postprocess_server."""
