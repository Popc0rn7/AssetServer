...
from assetserver.geometry_generation_server.dataclasses import (
...
def gpu_worker_main(
    ...
    try:
        from assetserver.geometry_generation_server.geometry_generation import (
    ...
    while True:
        try:
            ...
            try:
                ...
                artifact = GLOBAL_ARTIFACTS.register(result_data.geometry_path)
                result_queue.put(
                    WorkResult(
                        ...
                        status="success",
                        data={
                            "geometry_path": result_data.geometry_path,
...
def _preload_pipeline(backend: str, use_mini: bool, sam3d_config: dict | None) -> None:
    ...
    if backend == "hunyuan3d":
        from assetserver.geometry_generation_server.hunyuan3d_pipeline_manager import (
