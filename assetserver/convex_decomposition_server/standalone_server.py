#!/usr/bin/env python3
"""Standalone convex decomposition server.

This script starts a FastAPI server that handles convex decomposition requests
(CoACD and V-HACD). It must be run as a subprocess to isolate CoACD's OpenMP
from the main worker's ThreadPoolExecutor.

Usage:
    python -m assetserver.convex_decomposition_server.standalone_server \
