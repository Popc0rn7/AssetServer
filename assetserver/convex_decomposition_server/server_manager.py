...
from assetserver.convex_decomposition_server.client import (
    ConvexDecompositionClient,
)
from assetserver.utils.network_utils import find_available_port, is_port_available
...
class ConvexDecompositionServer:
    ...
    def start(self) -> None:
        ...
        try:
            ...
            # Set PYTHONPATH so subprocess can find assetserver module.
            env = os.environ.copy()
